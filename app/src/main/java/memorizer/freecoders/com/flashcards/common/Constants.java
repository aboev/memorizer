...
public class Constants {
    ...
    static {
        ...
        countryMap.put("zh-CN", "china_flag");
        countryMap.put("zh-pi", "china_flag");
        countryMap.put("zh-TW", "china_flag");
        countryMap.put("hy", "armenia_flag");
        countryMap.put("az", "azerbaijan_flag");
        ...
        countryMap.put("fr", "france_flag");
        countryMap.put("de", "germany_flag");
        countryMap.put("it", "italy_flag");
        countryMap.put("ja", "japan_flag");
        countryMap.put("ja-ro", "japan_flag");
        //countryMap.put("sl", "Slovenian");
        countryMap.put("ru", "russia_flag");
